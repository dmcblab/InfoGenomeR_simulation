...
#			if((test[test_i,4]== ploidy && true[true_i,4] == ploidy) || (test[test_i,4]-ploidy)*(true[true_i,4]-ploidy)>0 && test[test_i,4]-true[true_i,4]==0){
		       if(!is.na( test[test_i,5]) && !is.na (test[test_i,6]) && !is.na(true[true_i,5]) && !is.na(true[true_i,6]))
                       if((true[true_i,5] == test[test_i,5] && true[true_i,6] == test[test_i,6])||(true[true_i,5] == test[test_i,6] && true[true_i,6] == test[test_i,5])){
